...
function MensajesRecibidosG({ userId, eliminarMensaje, buscaMensajes, mensajesRecibidosG }){
    ...
    return (
        <div className='container'>
            <table className="table table-sm table-fixed table-hover" width="100%">
                ...
                <tbody>
                { !Array.isArray(mensajesRecibidosG) || mensajesRecibidosG.length === 0 ? ( 
                    <tr><td colSpan="4" className='text-center'>Sin mensajes</td></tr> 
                ) : (
                    mensajesRecibidosG.map(m => {
...
export default MensajesRecibidosG;
